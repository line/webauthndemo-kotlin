...
package com.linecorp.webauthn.sample.domain.remote
...
interface Fido2Api {
    ...
    suspend fun sendAuthenticationResponse(body: SendAuthenticationResponseInput): SendResponseResult

    suspend fun getRegistrationChallenge(body: GetRegistrationChallengeInput): GetRegistrationChallengeResult

    suspend fun sendRegistrationResponse(body: SendRegistrationResponseInput): SendResponseResult
}
